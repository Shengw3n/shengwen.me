...
<template>
  <div class="max-w-300 mx-auto">
    <p text-center mt--6 mb5 op50 text-lg italic>
      Projects I developed and contributed to:
    </p>
    ...
    >
      ...
      >
        <span text-5em color-transparent absolute left--1rem top-0rem font-bold leading-1em text-stroke-0.5 text-stroke-hex-aaa op45 dark:op30>{{ key }}</span>
      </div>
      <div
